...
## 8) Final metric-source clarification (documentation-only)
- **What changed**

- Added explicit clarification that 0.5589 is from model-level comparison, while ablation highest F1 is 0.5491 from ablation table values.
- **Model logic changed?** No
- **Target construction changed?** No
